...
4. **Multi-algorithm RL experiment** — PPO vs AMP compared head-to-head (16-run study, archived in open-duck-ppo-vs-amp); best policy (ppo_v3) selected for deployment
