...
| Phase 2: Isaac Lab + RL Training | 2.1-2.7 | Complete (Task 2.7 validation_results.md / push-recovery gate still outstanding) | DGX Spark |
| Phase 3: CAD Redesign + Thermal | 3.1-3.7 | In progress (cad-redesign worktree) | OnShape/Fusion |
...
4. Document results in `docs/jetson-mod/validation_results.md` or `docs/jetson-mod/algorithm_comparison.md`
...
| 2.5 | `docs/jetson-mod/algorithm_comparison.md` |
