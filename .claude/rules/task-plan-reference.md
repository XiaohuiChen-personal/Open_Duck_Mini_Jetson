...
The detailed implementation plan is in `docs/jetson-mod/task_plan.md` (2500+ lines, 28 tasks).
...
| Phase 3: CAD Redesign | 3.1-3.5 | Pending | OnShape/Fusion |
| Phase 4: Hardware Build | 4.1-4.5 | Pending | Jetson + 3D printer |
