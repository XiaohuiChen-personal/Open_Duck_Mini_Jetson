# Algorithm Comparison — Open Duck Mini v2 (v4 retrains, corrected layout-v2.1 model)

Standardized evaluation protocol applied to the post-CAD v4 retrains
(ppo_v3 baseline row, v4_inertials, v4_robust). Produced by
